...
$(function () {
    $('.course-dates').datepicker({
        ...
        clearButton: 'true',
        navTitles: {
            years: '<p>Choose Your Year</p>',
            months: '<p>Choose Your Month</p>',
            days: '<p>Choose Your Date</p>'
        }      
    });
});
